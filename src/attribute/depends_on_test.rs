...
/// https://android.googlesource.com/kernel/common/+/refs/heads/android16-6.12/drivers/auxdisplay/Kconfig
#[test]
fn test_parse_depends_on_tmp() {
    assert_parsing_eq!(
        parse_depends_on,
        r#"depends on PANEL_PROFILE="0" && PANEL_LCD="1" && PANEL_LCD_PROTO="0""#,
        Ok((
            "",
            DependsOn {
